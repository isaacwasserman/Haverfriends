...
def find_match_in_group(user_group, match_user_dict):
    ...
    match_user_dict[best_match_id_and_index[0]] = (user_group[0][0], str(min(best_match_id_and_index[0], user_group[0][0])) + '_' + str(max(best_match_id_and_index[0], user_group[0][0])))
